...
export default function Sidebar({
  ...
  const navItems: NavItem[] = [
    ...
    { id: 'dashboard', icon: 'dashboard', label: dict.sidebar.dashboard, href: '/dashboard', adminOnly: true, appTypes: ['microlending', 'autofinance', 'goldloan', 'chitfunds'] },
    { id: 'collection', icon: 'point_of_sale', label: dict.sidebar.collection, href: '/collection', appTypes: ['microlending', 'autofinance', 'goldloan', 'chitfunds'] },
    ...
    { id: 'accounting', icon: 'account_balance_wallet', label: dict.sidebar.accounting, href: '/accounting', adminOnly: true, appTypes: ['microlending', 'autofinance', 'goldloan', 'chitfunds'] },
    { id: 'wallet', icon: 'payments', label: (dict.sidebar as any).wallet || 'Agent Wallet', href: '/wallet', appTypes: ['microlending', 'autofinance', 'goldloan', 'chitfunds'] },
    { section: dict.sidebar.sections.insights },
    { id: 'analytics', icon: 'insights', label: dict.sidebar.analytics, href: '/analytics', adminOnly: true, appTypes: ['microlending', 'autofinance', 'goldloan', 'chitfunds'] },
