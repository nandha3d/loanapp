    ...
    <div style={{ maxWidth: '900px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div className="card" style={{ border: '1px solid var(--border)' }}>
        <div className="card-header" style={{ margin: 0 }}>
          <h3 style={{ margin: 0 }}>{customer ? `✏️ ${dict.customers.editTitle} — ${customer.name}` : `➕ ${dict.customers.registerTitle}`}</h3>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div className="card" style={{ border: '1px solid var(--border)' }}>
          <div className="card-header" style={{ borderBottom: '1px solid var(--border)', paddingBottom: '12px', marginBottom: '16px' }}>
            <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0, fontSize: '1.05rem', color: 'var(--primary-dark)', fontWeight: 600 }}>
              <span className="material-icons-outlined">person</span> 👤 {dict.customers.basicInformation || 'Basic Information'}
            </h3>
          </div>
        ...
        {/* Box 2: Route / Line Assignment */}
        <div className="card" style={{ border: '1px solid var(--border)' }}>
          <div className="card-header" style={{ borderBottom: '1px solid var(--border)', paddingBottom: '12px', marginBottom: '16px' }}>
            <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0, fontSize: '1.05rem', color: 'var(--primary-dark)', fontWeight: 600 }}>
              <span className="material-icons-outlined">alt_route</span> 🗺️ {dict.customers.routeAssignment || 'Route / Line Assignment'}
            </h3>
          </div>
          <div className="form-group" style={{ marginBottom: 0 }}>
            ...
            {isAgentViewer && localRoutes.length === 0 && (
              <small style={{ color: 'var(--danger)', display: 'block', marginTop: '6px' }}>No route assigned to you yet. Ask an admin to assign you a route in Settings.</small>
            )}
          </div>
        </div>

        {!isChit && (
          /* Box 3: Company / Business Details */
          <div className="card" style={{ border: '1px solid var(--border)' }}>
            <div className="card-header" style={{ borderBottom: showCompany ? '1px solid var(--border)' : 'none', paddingBottom: showCompany ? '12px' : 0, marginBottom: showCompany ? '16px' : 0 }}>
              <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0, fontSize: '1.05rem', color: 'var(--primary-dark)', fontWeight: 600 }}>
                <span className="material-icons-outlined">business</span> 🏢 {dict.customers.companyBusinessDetails || 'Company / Business Details'}
              </h3>
        ...
        {/* Box 4: Collection Points */}
        <div className="card" style={{ border: '1px solid var(--border)' }}>
          <div className="card-header" style={{ borderBottom: '1px solid var(--border)', paddingBottom: '12px', marginBottom: '16px' }}>
            <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0, fontSize: '1.05rem', color: 'var(--primary-dark)', fontWeight: 600 }}>
              <span className="material-icons-outlined">place</span> 📍 {dict.customers.collectionPointsSection || 'Collection Points'}
            </h3>
        ...
        <div className="card" style={{ border: '1px solid var(--border)' }}>
          <div className="card-header" style={{ borderBottom: '1px solid var(--border)', paddingBottom: '12px', marginBottom: '16px' }}>
            <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0, fontSize: '1.05rem', color: 'var(--primary-dark)', fontWeight: 600 }}>
              <span className="material-icons-outlined">description</span> 📄 {dict.customers.kycDocumentsSection || dict.customers.documents || 'KYC Documents'}
            </h3>
          </div>
        ...
        {!isChit && (
          /* Box 6: Guarantors / Surety */
          <div className="card" style={{ border: '1px solid var(--border)' }}>
            <div className="card-header" style={{ borderBottom: '1px solid var(--border)', paddingBottom: '12px', marginBottom: '16px' }}>
              <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0, fontSize: '1.05rem', color: 'var(--primary-dark)', fontWeight: 600 }}>
                <span className="material-icons-outlined">verified_user</span> 🤝 {dict.customers.guarantorSuretySection || dict.customers.guarantors || 'Guarantors / Surety'}
              </h3>
              <button type="button" className="btn btn-secondary btn-sm" onClick={addGuarantor} style={{ padding: '4px 10px', fontSize: '.78rem' }}>
