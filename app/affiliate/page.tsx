...
export default function PublicAffiliateLandingPage() {
  ...
  // Calculator State
  const [calcReferrals, setCalcReferrals] = useState(12);
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <section style={{ textAlign: 'center', marginBottom: '80px' }}>
          ...
          <p style={{
            ...
            Join our affiliate program today. Help lenders streamline daily collections, loan tracking, and accounting while earning a substantial 30% recurring payout.
          </p>
        </section>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '0.92rem', color: 'rgba(255,255,255,0.6)', lineHeight: '1.6', margin: 0 }}>
                Every superadmin referred by your link gets a 14-day free trial. Once 10 of your referred tenants upgrade to active paid plans, rewards unlock!
              </p>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                ...
                <div>
                  <h4 style={{ margin: '0 0 4px', fontSize: '0.95rem', fontWeight: 600, color: '#fff' }}>30% Commission Payout</h4>
                  <p style={{ margin: 0, fontSize: '0.85rem', color: 'rgba(255,255,255,0.5)' }}>
                    Refer as a monthly subscriber and get 30% of their subscription fees for 5 months.
                  </p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                ...
                <div>
                  <h4 style={{ margin: '0 0 4px', fontSize: '0.95rem', fontWeight: 600, color: '#fff' }}>1 Year Free Workspace</h4>
                  <p style={{ margin: 0, fontSize: '0.85rem', color: 'rgba(255,255,255,0.5)' }}>
                    Refer as a yearly subscriber and get a full 1-year free credit for your own lending workspace!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: '0.72rem', color: 'rgba(255,255,255,0.4)', marginTop: '4px' }}>
                  Based on 30% × 5 months referred revenue (Threshold Met)
                </div>
              </div>
            </div>
          </div>
