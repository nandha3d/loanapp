...
Same export buttons as P&L. The PDF template (`lib/accounting/pdfs/balanceSheet.tsx`) renders A4 portrait, includes a "Director's signature" placeholder block at the bottom, and a footer with `<asOf>`, page number, and "Generated by ZoloFund Premium".
