...
## ZoloFund — Local Development + Hostinger Production
...
SMTP_FROM="ZoloFund <noreply@loantrack.com>"
...
```
zolofund/                  ← monorepo root (or keep as one Next.js app)
...
/// Environment configuration for ZoloFund mobile app.
...
import 'package:zolofund/config/env.dart';
