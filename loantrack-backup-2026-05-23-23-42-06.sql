...
CREATE TABLE `customers` (
  ...
  `aadhaar_dob` varchar(191) DEFAULT NULL,
  `aadhaar_name` varchar(191) DEFAULT NULL,
  `aadhaar_photo` varchar(191) DEFAULT NULL,
  `aadhaar_verified` tinyint(1) NOT NULL DEFAULT 0,
  `kyc_method` varchar(191) DEFAULT NULL,
  `kyc_rejected_reason` text DEFAULT NULL,
  `kyc_verified_at` datetime(3) DEFAULT NULL,
  `kyc_verified_by_id` varchar(191) DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `customers_kyc_verified_by_id_fkey` (`kyc_verified_by_id`),
  ...
  CONSTRAINT `customers_kyc_verified_by_id_fkey` FOREIGN KEY (`kyc_verified_by_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
('cmpfiuboz0004ag49a4iuhrvb','cmpfiubop0000ag49wddz1ao0','cmpfiubov0002ag49jkcx4rvd','CUST-001','Test Customer','1234567890',NULL,NULL,NULL,NULL,'approved',NULL,NULL,'active',NULL,'microlending','2026-05-21 13:23:29.075','2026-05-21 13:23:29.075',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL),
('cmpfiv43w00049n0meipduf5h','cmpfiv43o00009n0mf3sl2e2t','cmpfiv43u00029n0mxiai317r','CUST-001','Test Customer','1234567890',NULL,NULL,NULL,NULL,'approved',NULL,NULL,'active',NULL,'microlending','2026-05-21 13:24:05.901','2026-05-21 13:24:05.901',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL),
('cmpie6f8a000u6p68pbfyie3p','cmpidzhq500026p68kx42vzr4','cmpie0at6000a6p68mp3bjfla','ER-CUS-0001','Vignesh Sinnamaiyappan','07442941290','James black road, Flat 13, room 3, Manor Park student village,\r\nReception, 1 Alexander Fleming Road',NULL,'cmpie1egq000e6p682f3rlg3v','cmpie44xk000i6p68f1d20twu','pending',NULL,NULL,'active',NULL,'microlending','2026-05-23 13:36:13.978','2026-05-23 13:36:13.978',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL);
...
--
-- Table structure for table `kyc_sessions`
--
...
CREATE TABLE `kyc_sessions` (
  ...
  `digio_request_id` varchar(191) DEFAULT NULL,
  `digio_entity_id` varchar(191) DEFAULT NULL,
  `otp_reference` varchar(191) DEFAULT NULL,
  `otp_expires_at` datetime(3) DEFAULT NULL,
  `video_file_path` varchar(191) DEFAULT NULL,
  `video_file_name` varchar(191) DEFAULT NULL,
  `video_uploaded_at` datetime(3) DEFAULT NULL,
  `reviewed_by_id` varchar(191) DEFAULT NULL,
  `reviewed_at` datetime(3) DEFAULT NULL,
  `review_notes` text DEFAULT NULL,
  `response_data` text DEFAULT NULL,
  `initiated_by_id` varchar(191) DEFAULT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT current_timestamp(3),
  `updated_at` datetime(3) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `kyc_sessions_tenant_id_customer_id_idx` (`tenant_id`,`customer_id`),
  KEY `kyc_sessions_digio_request_id_idx` (`digio_request_id`),
  KEY `kyc_sessions_customer_id_fkey` (`customer_id`),
  KEY `kyc_sessions_initiated_by_id_fkey` (`initiated_by_id`),
  KEY `kyc_sessions_reviewed_by_id_fkey` (`reviewed_by_id`),
  CONSTRAINT `kyc_sessions_customer_id_fkey` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `kyc_sessions_initiated_by_id_fkey` FOREIGN KEY (`initiated_by_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `kyc_sessions_reviewed_by_id_fkey` FOREIGN KEY (`reviewed_by_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `kyc_sessions_tenant_id_fkey` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `kyc_sessions`
--
...
('cmp87ky4x0001z45xon2cjo0w','cmp1cxexi0000m5lsfbfigi9x','basic','active',200,10,'[\"microlending\",\"autofinance\",\"chitfunds\"]','2026-05-15 00:00:00.000','2026-05-31 00:00:00.000',NULL,'2026-05-16 10:33:52.588','2026-05-20 11:20:15.192',NULL,1,0,0,0,50,0,0,0),
('cmpidzhvb00086p68cvxjltii','cmpidzhq500026p68kx42vzr4','trial','active',100,5,'[\"microlending\"]',NULL,NULL,NULL,'2026-05-23 13:30:50.807','2026-05-23 13:42:40.598',NULL,1,0,0,0,50,0,0,0);
...
-- Dump completed on 2026-05-23 23:42:08
