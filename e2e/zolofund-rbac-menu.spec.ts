...
import { createUiEvidenceRecorder, makeUiGap } from '../tests/e2e/helpers/zolofundEvidence';
import { cleanupZoloFundUiScenario, seedZoloFundUiScenario, type ZoloFundUiSeed } from '../tests/e2e/helpers/zolofundSeed';
import { loginAs, menuLink, modulePath } from '../tests/e2e/helpers/zolofundSelectors';

test.describe('ZoloFund RBAC and menu visibility', () => {
  ...
  const evidence = createUiEvidenceRecorder({
    runId,
    source: 'e2e/zolofund-rbac-menu.spec.ts',
