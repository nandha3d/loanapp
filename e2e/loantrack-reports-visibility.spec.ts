...
import { createUiEvidenceRecorder } from '../tests/e2e/helpers/loantrackEvidence';
import { cleanupLoanTrackUiScenario, seedLoanTrackUiScenario, type LoanTrackUiSeed } from '../tests/e2e/helpers/loantrackSeed';
import { expectNonBlankAppPage, loginAs, modulePath } from '../tests/e2e/helpers/loantrackSelectors';

test.describe('LoanTrack reports visibility', () => {
  ...
  const evidence = createUiEvidenceRecorder({
    runId,
    source: 'e2e/loantrack-reports-visibility.spec.ts',
