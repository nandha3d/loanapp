...
let cachedSeed: LoanTrackUiSeed | null = null;
...
export async function seedLoanTrackUiScenario(runId = getRunId()): Promise<LoanTrackUiSeed> {
...
export async function cleanupLoanTrackUiScenario(runId = getRunId()) {
  cachedSeed = null;
  await cleanupRunData(runId);
}
