...
export const routes = {
  ...
  chitAuctionMessages: '../../../app/api/v1/chits/[id]/auctions/[auctionId]/messages/route.ts',
  chitAuctionAdmission: '../../../app/api/v1/chits/[id]/auctions/[auctionId]/admission/route.ts',
  borrowerChitAuctionLive: '../../../app/api/v1/borrower/chits/[id]/auctions/[auctionId]/live/route.ts',
  borrowerChitAuctionJoin: '../../../app/api/v1/borrower/chits/[id]/auctions/[auctionId]/join/route.ts',
  borrowerChitAuctionBids: '../../../app/api/v1/borrower/chits/[id]/auctions/[auctionId]/bids/route.ts',
  borrowerChitAuctionMessages: '../../../app/api/v1/borrower/chits/[id]/auctions/[auctionId]/messages/route.ts',
